...
WeixinRailsMiddleware.configure do |config|
  ...
  config.public_account_class = "Public"
  ...
  # config.weixin_token_string = '11400055ccdb6e25112ba093'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = 'GLflZyRKnMWqR3A2TNq-tO_ogMNm3aZW'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '23ab2bfb5a19a809e58bb74217ce8871fa60bf8cf2e'
